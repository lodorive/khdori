...
@ToString(of = {"memberId", "memberLevel", "memberNickname", "chatRoomNo", "clubNo"}) //출력할 때 작성한 항목만 출력해라
public class ClientVO {
	@JsonIgnore //Json으로 변환하는 과정에서 이 필드는 제외한다
	private WebSocketSession session;
	private String memberId, memberLevel, memberNickname;
	private Date chatTime;	
	
	private Integer chatRoomNo, clubNo;
	...
	public ClientVO(WebSocketSession session) {
		...
		this.memberNickname = (String) attr.get("nickname");
